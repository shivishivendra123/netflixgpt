...
const Login = ()=>{
    ...
    return (
        <div>
            ...
            <form className="bg-black absolute w-4/12 my-24 p-10 mx-auto right-0 left-0 text-white bg-opacity-80">
                ...
                <input type="text" placeholder="Email Address" className="p-2 my-4 w-full bg-slate-500  font-bold"/>
                <input type="password" placeholder="Enter Password" className="p-2 my-4 w-full bg-slate-500 font-bold"/>
                {!loginForm?<input type="password" placeholder="Confirm Password" className="p-2 my-4 w-full bg-slate-500 font-bold"/>:null} 
                <button className="bg-[#E50914] w-full my-4 h-[50px] rounded-md" type="submit">{loginForm?"Log In":"Sign Up"}</button> 
